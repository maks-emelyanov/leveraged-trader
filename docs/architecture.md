...
Workflow-level system benchmarking is collected around the orchestration run and emitted at the output boundary as the final terminal footer plus `workflow_benchmark.csv`.
